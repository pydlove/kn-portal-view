...
import {updateRkArticle} from '@/api/ruankao/article/article'
import {RkArticleVO} from './type'
...
// 预览文章
const previewArticle = ref<RkArticleVO>({} as RkArticleVO)
...
// 打开编辑模态框
const openModal = async (article: RkArticleVO, menus: IdNameVO[]) => {
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // 更新文章
    if (articleForm.id) {
      await updateRkArticle(articleForm.id, {
