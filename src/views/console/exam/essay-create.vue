<!-- src/views/console/exam/essay-create.vue -->
<template>
  <div class="essay-create-container">
    <a-card title="创建论文题">
      ...
      >
        ...
        >
          <a-textarea
            v-model:value="formState.essayDetail.requirement"
            placeholder="请输入题目要求"
        ...
        >
          <a-input-group compact>
            <a-input
              v-model:value="formState.essayDetail.wordLimitMin"
              placeholder="最小字数"
              style="width: 40%"
            />
            <a-input
            ...
            />
            <a-input
              v-model:value="formState.essayDetail.wordLimitMax"
              placeholder="最大字数"
        ...
        >
          <a-textarea
            v-model:value="formState.essayDetail.referenceAnswer"
            placeholder="请输入参考答案"
            :auto-size="{ minRows: 4, maxRows: 8 }"
          />
        </a-form-item>
        ...
        >
          <a-textarea
            v-model:value="formState.essayDetail.scoringCriteria"
            placeholder="请输入评分标准"
            :auto-size="{ minRows: 4, maxRows: 8 }"
          />
        </a-form-item>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await createEssayQuestion({
      ...
      essayDetail: formState.essayDetail
    });

    message.success('创建论文题成功');
