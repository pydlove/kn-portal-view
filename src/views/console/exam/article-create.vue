<!-- src/views/console/exam/article-create.vue -->
<template>
            ...
            <a-tab-pane key="editor" tab="编辑">
              <div class="markdown-editor">
                ...
                <div class="editor-help">
                  <a href="https://markdown.com.cn/" target="_blank">Markdown 语法参考</a>
                </div>
              </div>
            </a-tab-pane>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    submitForm.question.title = formState.title;
    submitForm.articleDetail.title = formState.title;
    submitForm.articleDetail.content = formState.content;

    // 提交数据
    await createArticleQuestion({
      question: submitForm.question,
      articleDetail: submitForm.articleDetail
    });

    message.success('创建文章题成功');
